package com.github.mateqh.clans.listener;
...
import com.github.mateqh.clans.util.StringUtil;
...
//        }
    ...
    public void onAsyncPlayerChat(AsyncPlayerChatEvent event) {
        ...
        String prefix = clan != null ? StringUtil.translate(Config.CLAN.CHAT_PREFIX.replaceAll("%name%", clan.getName())) : "";
