...
public class InfoArgument extends ExecutorArgument {
    ...
    public void printDetails(CommandSender sender, Team team) {
        ...
        for (int i = 0; i < members.size(); i++) {
            OfflinePlayer member = PlayerCache.getPlayer(members.get(i));
        ...
        for (int i = 0; i < captains.size(); i++) {
            OfflinePlayer captain = PlayerCache.getPlayer(captains.get(i));
        ...
        OfflinePlayer leader = PlayerCache.getPlayer(team.getLeader());
